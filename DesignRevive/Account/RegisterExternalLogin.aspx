<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="DesignRevive.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="DesignRevive" %>
